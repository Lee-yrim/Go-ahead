	...
	<div class="content">
		<ul class="nav justify-content-end" id="myTab" role="tablist">
		 <li class="nav-item" role="presentation">
		 	<button class="nav-link active" id="card-tab" data-bs-toggle="tab" data-bs-target="#card" type="button" role="tab" aria-controls="card" aria-selected="true" onClick="location.href='camping.do'">카드</button>
		 </li>
		 <li class="nav-item" role="presentation">
		...
		<!-- <input type="button" value="지도" onClick="location.href='kakaomap.do'"/> -->
